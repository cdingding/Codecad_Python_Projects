...
class War(object):
    ...
    def play_game(self):
        while self.winner is None:
            self.play_round()
        self.display_winner()
        self.display_cards() #added by Ding
    ...
    def display_cards(self):
        print "%s has %s cards and %s has %s cards." %(self.player1.name, self.cards_to_str(cards1), self.player2.name, self.cards_to_str(cards2))
